...
function dataSection(ctx, mealCount) {
  ...
  return el(
    'div',
    { class: 'card stack' },
    el('p', { class: 'small muted', text: `${mealCount} Mahlzeiten gespeichert.` }),
    el(
      'button',
      {
        class: 'btn',
    ...
    importInput,
    el('p', { class: 'hint' },
      'Der Export enthält Mahlzeiten, Favoriten und Ziele — ohne Fotos (die würden die Datei ' +
  ...
  mount(
    ...
    el(
      ...
      el(
        ...
        'Alle Mahlzeiten und Fotos bleiben auf diesem Gerät. ' +
